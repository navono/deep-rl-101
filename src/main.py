...
def parse_args():
    ...
    parser.add_argument(
        ...
        nargs="?",
        default="llm",
        choices=["llm", "img", "unit_0_luna", "unit_0_train", "unit_0_eva", "unit_0_play", "unit_0_api", "basic_rl", "rl_spaces", "blackjack_train", "blackjack_eva", "blackjack_analyze", "gridworld_train", "gridworld_eva"],
